...
from app.services.person_management_service import PersonManagementService, DefaultPersonManagementService
...
class Container(containers.DeclarativeContainer):
    ...
    person_management_service: Callable[[], PersonManagementService] = providers.Factory(
